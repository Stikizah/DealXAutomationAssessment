package DealX.utilities;

import DealX.utilities.datahelpers.IdNumberValidator;
    ...
    public String GenerateRequiredData(String dataTypeRequired) {
        ...
        switch (dataTypeRequired.toUpperCase()) {
            ...
            case "GENERATED EMAIL":
                ...
                requiredData = firstName.toLowerCase() + faker.number().digits(5) + "@mailinator.com".toLowerCase();
                currentEmail = requiredData;
                break;
            case "GENERATED EMAIL - USE NAME":
                requiredData = currentFirstName.toLowerCase() + faker.number().digits(5) + "@mailinator.com".toLowerCase();
                currentEmail = requiredData;
                break;
