        ...
        for (int i = 1; i < rowCount; i++) {
            ...
            if (execute.toUpperCase().equals("TRUE")) {
                ...
                for (int j = 1; j < testStepsCount; j++) {
                    ...
                    testStepsModel.Campaign_code = excelDataHandlers.GetCellData("campaign_code", j, testSheet);
                    testStepsModel.First_name = excelDataHandlers.GetCellData("first_name", j, testSheet);
