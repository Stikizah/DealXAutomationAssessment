...
import DealX.reporting.ExtentTestManager;
import DealX.utilities.ALM_Wrapper;
import DealX.utilities.TestDataCreator;
...
public class DealXBasePageTest extends TestBase implements ITest {

    private String testCaseName;
    private String newTestName;
    private SoftAssert assertion;
    @DataProvider(name = "DealXWebFlowsFromExcel")
    ...
    @Test(dataProvider = "DealXWebFlowsFromExcel")
